...
def Matching():
    ...
    print(f'{session} this is session')
    ...
    resume_experience_list = ['4 years 3 months ' , '3 months' , '5 years' , '6 years' , '10 years']
    print("resume_experience: ",resume_experience_list)
    print(resume_experience_list)
    resume_experience = []
    ...
    if resume_workedAs:
        ...
        print('Workes as ',resume_workedAs)
        for i, item in enumerate(resume_workedAs):
            if item in jd_post:
                result = True
                match_index = i
                print(f'workes as resume',{i})
