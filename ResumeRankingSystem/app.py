...
client_secrets_file = os.path.join(pathlib.Path(__file__).parent, "client.json") #verify this
...
app.config['MONGO_URI']= 'mongodb://localhost:27017/Resume_Parser'
...
def HR():
    if request.method == 'POST':
        ...
        # Render the form template without any message
